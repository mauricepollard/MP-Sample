...
$conditional_query = "SELECT address,latitude,longitude FROM EDay_walk_list_A WHERE longitude !=' ' AND volunteer_id = 52";
...
<a href="http://www.edayapp.com/imap.php">Map</a>
</body>
</html>